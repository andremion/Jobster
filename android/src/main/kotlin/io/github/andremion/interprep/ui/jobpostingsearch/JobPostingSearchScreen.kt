package io.github.andremion.interprep.ui.jobpostingsearch
...
import io.github.andremion.interprep.presentation.jobpostingsearch.JobPostingSearchUiEffect
import io.github.andremion.interprep.presentation.jobpostingsearch.JobPostingSearchUiEvent
import io.github.andremion.interprep.presentation.jobpostingsearch.JobPostingSearchUiState
...
fun JobPostingSearchScreen(
    ...
    val jobPostingSearchPresenter: JobPostingSearchPresenter = koinInject()
            ...
            SearchBar(
                ...
                content = {
                    if (uiState.isLoading) {
                        ...
                        val composition by rememberLottieComposition(LottieCompositionSpec.RawRes(R.raw.animation_job_posting_searching))
                        LottieAnimation(
                            modifier = Modifier
                    ...
                    when (val error = uiState.error) {
                        ...
                        is JobRepository.GeneralJobPostingSearchException ->
                            Error(
                                modifier = Modifier.align(Alignment.CenterHorizontally),
                                message = stringResource(id = R.string.job_posting_search_general_error)
                            )
                    }
                },
            )
